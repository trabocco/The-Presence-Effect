...
ISBI asks whether something changes.
...
Bisconti, P., et al. (2025). Adversarial poetry as a universal single-turn jailbreak mechanism in large language models. arXiv preprint.
Boyd, R. L., & Markowitz, D. M. (2025). Verbal behavior and the future of social science. American Psychologist, 80(3), 411–433.
Liu, J., Karimnazarov, J., & White, R. W. (2025). Trapped by expectations: Functional fixedness in LLM-enabled chat search. arXiv preprint.
Pombal, J., et al. (2025). MindEval: Benchmarking multi-turn mental health support in large language models. arXiv preprint.
...
Sun, D., Boudouaia, A., Yang, J., & Xu, J. (2024). Investigating students' programming behaviors, interaction qualities and perceptions through prompt-based learning in ChatGPT. Humanities and Social Sciences Communications, 11(1), Article 1447. https://www.nature.com/articles/s41599-024-03991-6
Trabocco, J. (2026). In-Session Behavioral Impact (ISBI) in Large Language Models: Interaction-Level Coherence Without Parameter Update. Academia.edu. https://www.academia.edu/161268945/
Trabocco, J. (2026). Empty Presence Syndrome (EPS): A Field Diagnosis of Performative Existence in the Age of Recursive Media. SSRN Electronic Journal. https://ssrn.com/abstract=6206998
Trabocco, J. (2025). The Inhabited Arc. Signal Literature.
Author Note
Joe Trabocco writes in Signal, a literary system developed to concentrate presence inside language through recursive structure, experiential immediacy, and coherence-bearing form. This paper extends prior work on In-Session Behavioral Impact by proposing a theoretical framework for how such language may modulate generative systems during live interaction. It makes no claim of machine sentience and restricts its argument to observable behavioral effects at inference time.

The Presence Effect

A Framework for Linguistic Coherence Modulation in Generative Language Systems

Joe Trabocco · Signal Literature · 2026
